...
class MultiWalkerEnv(object):
    ...
    def __init__(self, 
        ...
        init_x = TERRAIN_STEP*TERRAIN_STARTPAD/2
        init_y = TERRAIN_HEIGHT+2*LEG_H
        self.start_x = [init_x+WALKER_SEPERATION*i*TERRAIN_STEP for i in xrange(self.n_walkers)]
    ...
    def observation_space(self):
        ...
        return spaces.Box(low=-np.inf, high=np.inf, shape=(24+2*(self.n_walkers-1)+3+1,))
